...
#define OIL_C      CLITERAL(Color){ 0, 0, 0, 245 }
#define BEDROCK_C  CLITERAL(Color){ 12, 15, 8, 200 }
#define ROCK_C     CLITERAL(Color){ 100, 100, 110, 240 }
#define GASOLINE_C CLITERAL(Color){ 211, 176, 131, 100 }
#define LAVA_C     CLITERAL(Color){ 179, 30, 0, 230 }
